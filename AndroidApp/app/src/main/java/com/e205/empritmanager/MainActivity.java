...
//    Socket Initialization
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        motorState = (TextView) findViewById(R.id.textView_motor_state);
        controlMode = (TextView) findViewById(R.id.textView_control_mode);
        motorMode = (Switch) findViewById(R.id.switch_motor_mode);
                ...
                if (data.contains("android")){
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            motorMode.setChecked(antaresControlMode.equals("Auto"));
                        }
                    });
                }
